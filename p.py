            ...
            if msg.contentType == 13:
                ...
                if msg.toType == 2:
                    ...
                    if group.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"👊ยกเชินหมุดแล้วคับนายท่าน👊")
                        else:
                            cl.sendText(msg.to,"Invite people inside not👈")
                else:
                    if wait["lang"] == "JP":
...
#--------------------------------------------------------
            ...
            elif msg.text in ['เปิดป้องกัน']:
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"😘9999999เปิดป้องกันวี20เสดแล้วคร่าบนายท่าน😘 􀜁􀇔􏿿👈")
                    else:
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"It is already On ô€¨")
            elif msg.text.lower() == 'เข้ากลุ่มออโต้เปิด':
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
            ...
            elif msg.text.lower() == 'เข้ากลุ่มออโตปิด':
            ...
            elif msg.text in ["Auto leave off","ปิดกันรัน"]:
                ...
                if wait["protect"] == True: md+="􀜁􀇔􏿿 ป้องกัน เปิด 🔓\n"
                else:md+="􀜁􀇔􏿿 ป้อกัน  ปิด🔒\n"
                ...
                cl.sendMessage(msg)
            elif msg.text.lower() == 'สุดหล่อ':
                msg.contentType = 13
                msg.contentMetadata = {'mid': mid}
                cl.sendMessage(msg)
            elif cms(msg.text,["creator","แอดมิน"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': admsa}
                ...
                if album["result"]["items"] == []:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"🙏ลบรันเสดแล้วคร่าบเจ้านาย🙏")
                    else:
...
#-----------------------------------------------------------
            elif msg.text.lower() == 'ชื่อไร':
                profile = ki.getProfile()
                text = profile.displayName + "􀜁􀅔เงี่ยน"
                ...
                profile = ki5.getProfile()
                text = profile.displayName + "􀜁􀅔ตอนนี้ได้หมุดน่ะ"
                ki5.sendText(msg.to, text)
                profile = ki6.getProfile()
                text = profile.displayName + "􀜁􀅔เยสแม่โคตเงี่ยน"
...
#---------------------------------------------------
            elif msg.text in ["Kembali","คืน"]:
                    try:
                       cl.updateDisplayPicture(backup.pictureStatus)
                       cl.updateProfile(backup)
                       cl.sendText(msg.to, "🙏คืนร่างแล้วสัส🙏")
...
#-------------Fungsi Tagall User Start---------------#
            elif msg.text in ["Tagall","dor","Ngntd","ngntd","Cum","cum"]:
                group = cl.getGroup(msg.to)
...
#-----------------------------------------------
                ...
                start = time.time()
                cl.sendText(msg.to, "เชคความเร็ว")
                elapsed_time = time.time() - start
...
#-----------------------------------------------
            ...
            elif msg.text.lower() == 'ขอเสียง':
                ki.sendText(msg.to,"Ping 􀜁􀇔ขอเสียงแน่คับ")
                ki2.sendText(msg.to,"Ping 􀜁􀇔􀇔ขอเสียงแน่คับ")
                ki3.sendText(msg.to,"Ping 􀜁􀇔􀇔ขอเสียงแน่คับ")
                ki4.sendText(msg.to,"Ping 􀜁􀇔􀇔ขอเสียงแน่คับ")
                ki5.sendText(msg.to,"Ping 􀜁􀇔􀇔ขอเสียงแน่คับ")
                ki6.sendText(msg.to,"Ping 􀜁􀇔􀇔ขอเสียงแน่คับ")
